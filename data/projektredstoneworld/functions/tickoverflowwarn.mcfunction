...
execute if score #rwgametimeof info matches ..2117483647 run tellraw @a[tag=admin] [{"text":"Time until gametime overflow: ", "color":"#AAAAAA"}, {"score":{"name":"#daysleftuntilof","objective":"info"}},{"text":"d "},{"score":{"name":"#hoursleftuntilof","objective":"info"}},{"text":"h "},{"score":{"name":"#minsleftuntilof","objective":"info"}},{"text":"m "},{"score":{"name":"#secsleftuntilof","objective":"info"}},{"text":"s"}]
execute if score #rwgametimeof info matches 2117483648..2142483647 run tellraw @a[tag=admin] [{"text":"Time until gametime overflow: ", "color":"yellow"}, {"score":{"name":"#daysleftuntilof","objective":"info"}},{"text":"d "},{"score":{"name":"#hoursleftuntilof","objective":"info"}},{"text":"h "},{"score":{"name":"#minsleftuntilof","objective":"info"}},{"text":"m "},{"score":{"name":"#secsleftuntilof","objective":"info"}},{"text":"s"}]
execute if score #rwgametimeof info matches 2142483648.. run tellraw @a[tag=admin] [{"text":"Time until gametime overflow: ", "color":"red"}, {"score":{"name":"#daysleftuntilof","objective":"info"}},{"text":"d "},{"score":{"name":"#hoursleftuntilof","objective":"info"}},{"text":"h "},{"score":{"name":"#minsleftuntilof","objective":"info"}},{"text":"m "},{"score":{"name":"#secsleftuntilof","objective":"info"}},{"text":"s"}]
