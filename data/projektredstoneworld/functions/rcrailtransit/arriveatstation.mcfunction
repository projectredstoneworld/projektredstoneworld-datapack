...
execute at @s as @e[type=minecart,tag=rcraildrive,distance=..2] run tag @s add openingrcr
execute at @s as @e[type=minecart,tag=rcraildrive,tag=openingrcr,distance=..2,tag=!rcrailghost] run function projektredstoneworld:rcrailtransit/dooropen1
