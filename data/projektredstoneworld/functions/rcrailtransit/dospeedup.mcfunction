...
execute at @s if score @s rcrspeedupspeed > @s rcrspeeduppspeed run playsound minecraft:block.beacon.activate neutral @a[distance=..48] ~ ~ ~ 1.5 2 0.4
execute at @s if score @s rcrspeedupspeed < @s rcrspeeduppspeed run playsound minecraft:block.beacon.deactivate neutral @a[distance=..48] ~ ~ ~ 1.5 2 0.4
scoreboard players operation @s rcrspeeduppspeed = @s rcrspeedupspeed

execute at @s run playsound minecraft:block.bell.resonate neutral @a[distance=..32] ~ ~ ~ 0.2 0 0.2
