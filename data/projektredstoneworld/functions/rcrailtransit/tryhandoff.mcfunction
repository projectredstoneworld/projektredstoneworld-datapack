...
# Tell marker what player summoned pod
execute if entity @s[tag=rcrailneg] at @e[type=marker,distance=..15,tag=rcsneg] run scoreboard players operation @e[type=marker,distance=..15,tag=rcsneg] redstoneworldID = @s redstoneworldID
execute if entity @s[tag=rcrailpos] at @e[type=marker,distance=..15,tag=rcspos] run scoreboard players operation @e[type=marker,distance=..15,tag=rcspos] redstoneworldID = @s redstoneworldID
