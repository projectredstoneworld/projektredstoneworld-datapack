...
execute in overworld as @e[type=marker,x=0,tag=rcsneg] at @s if entity @e[type=minecart,tag=rcraildrive,distance=..1] unless score @a[tag=rcrailpass3,tag=rcrailneg,limit=1,sort=nearest,distance=..32] redstoneworldID = @s redstoneworldID as @e[type=minecart,tag=rcraildrive,distance=..1] run function projektredstoneworld:rcrailtransit/killrcrailcar
execute in overworld as @e[type=marker,x=0,tag=rcspos] at @s if entity @e[type=minecart,tag=rcraildrive,distance=..1] unless score @a[tag=rcrailpass3,tag=rcrailpos,limit=1,sort=nearest,distance=..32] redstoneworldID = @s redstoneworldID as @e[type=minecart,tag=rcraildrive,distance=..1] run function projektredstoneworld:rcrailtransit/killrcrailcar
