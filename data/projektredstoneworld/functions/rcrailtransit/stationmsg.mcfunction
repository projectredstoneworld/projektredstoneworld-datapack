...
execute as @a[tag=seenrcrailmsg,tag=rcrailpasstrig1,tag=!rcrailoneway] at @s run function projektredstoneworld:rcrailtransit/chooseidealdir

# Original Tellraw execute as @a[tag=seenrcrailmsg,tag=rcrailpasstrig1,tag=!rcrailoneway] run tellraw @s ["",{"text":"R","bold":true,"color":"#FF0000"},{"text":"Corp","bold":true,"color":"red"},{"text":" Rail Network ","bold":true,"color":"dark_aqua"},{"text":"by Ij and Void","color":"aqua"},{"text":"\n"},{"text":"\n"},{"text":"Your current station requires a depart direction to proceed, please click one.","bold":true,"color":"green"},{"text":"\n"},{"text":"Mobile Users! Use /trigger rcrailtrig set <ID> the ID number is next to direction name!","color":"gray"},{"text":"\n"},{"text":"\n"},{"text":"Northbound/Westbound (18)","bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/trigger rcrailtrig set 18"}},{"text":"\n"},{"text":"Southbound/Eastbound (19)","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger rcrailtrig set 19"}}]

execute as @a[tag=seenrcrailmsg,tag=rcrailpasstrig1,tag=!rcrailoneway,tag=rcsidealnw] run tellraw @s ["",{"text":"R","bold":true,"color":"#FF0000"},{"text":"Corp","bold":true,"color":"red"},{"text":" Rail Network ","bold":true,"color":"dark_aqua"},{"text":"by Ij and Void","color":"aqua"},{"text":"\n"},{"text":"\n"},{"text":"Your current station requires a depart direction to proceed, please click one.","bold":true,"color":"green"},{"text":"\n"},{"text":"Mobile Users! Use /trigger rcrailtrig set <ID> the ID number is next to direction name!","color":"gray"},{"text":"\n"},{"text":"\n"},{"text":"Northbound/Westbound **RECOMMENDED** (18)","bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/trigger rcrailtrig set 18"}},{"text":"\n"},{"text":"Southbound/Eastbound (19)","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger rcrailtrig set 19"}},{"text":"\n\nPlease note that the North/Westbound has been marked as recommended based off an ideal grid routing system and may not be entirely accurate, but you may choose either direction you like!","color":"gray"}]

execute as @a[tag=seenrcrailmsg,tag=rcrailpasstrig1,tag=!rcrailoneway,tag=rcsidealse] run tellraw @s ["",{"text":"R","bold":true,"color":"#FF0000"},{"text":"Corp","bold":true,"color":"red"},{"text":" Rail Network ","bold":true,"color":"dark_aqua"},{"text":"by Ij and Void","color":"aqua"},{"text":"\n"},{"text":"\n"},{"text":"Your current station requires a depart direction to proceed, please click one.","bold":true,"color":"green"},{"text":"\n"},{"text":"Mobile Users! Use /trigger rcrailtrig set <ID> the ID number is next to direction name!","color":"gray"},{"text":"\n"},{"text":"\n"},{"text":"Northbound/Westbound (18)","bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/trigger rcrailtrig set 18"}},{"text":"\n"},{"text":"Southbound/Eastbound **RECOMMENDED** (19)","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger rcrailtrig set 19"}},{"text":"\n\nPlease note that the South/Eastbound has been marked as recommended based off an ideal grid routing system and may not be entirely accurate, but you may choose either direction you like!","color":"gray"}]
...
execute in overworld as @a[tag=rcrailrider,x=0,scores={rcrailtrig=-1}] unless score @s rcorpsec matches 2.. if score #rcraildisable info matches 1 run scoreboard players reset @s rcrailtrig
