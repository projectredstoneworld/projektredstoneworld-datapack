...
execute if score #tagbounds info matches -1 if score #tagchasec info matches 2.. in overworld as @s[tag=pontokaskibiditoilet] run tp @s -8.594 90 108.241 3 -18.3
execute if score #tagbounds info matches -1 if score #tagchasec info matches 2.. in overworld as @s[tag=pontokaskibiditoilet] run tellraw @s "You have been placed near the start of the bridge. Make your way to the RTC Towers to start chasing again!"
...
execute if score #tagbounds info matches 2 in overworld as @s[tag=pontokaskibiditoilet] run tp @s -8.594 90 108.241 3 -18.3
execute if score #tagbounds info matches 2 in overworld as @s[tag=pontokaskibiditoilet] run tellraw @s "You have been placed near the start of the bridge. Make your way to the RTC Towers to start chasing again!"
