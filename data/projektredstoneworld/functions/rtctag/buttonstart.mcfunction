...
execute if score #tagchasers info matches 0 if score #tagpcound info matches ..2 run scoreboard players set #tagstatus info 0
execute if score #tagchasers info matches 1 if score #tagpcound info matches ..2 run scoreboard players set #tagstatus info 0
execute if score #tagchasers info matches 2 if score #tagpcound info matches ..3 run scoreboard players set #tagstatus info 0
execute if score #tagchasers info matches 3 if score #tagpcound info matches ..4 run scoreboard players set #tagstatus info 0
execute if score #tagchasers info matches 4 if score #tagpcound info matches ..5 run scoreboard players set #tagstatus info 0
