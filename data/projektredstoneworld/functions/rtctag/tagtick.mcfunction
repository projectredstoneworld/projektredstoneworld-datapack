...
execute as @a[tag=pontokaemer] at @s unless entity @s[tag=pontokaemercart] unless entity @s[y=-9,dy=2] unless entity @s[y=55,dy=2.5] unless entity @s[y=76,dy=2.5] unless entity @s[y=82,dy=2.5] unless entity @s[y=95,dy=2.5] unless entity @s[y=113,dy=2.5] unless entity @s[y=140,dy=3] unless entity @s[y=168,dy=2.5] unless entity @s[y=191,dy=2.5] at @s run function projektredstoneworld:rtctag/emergencyexitbringback
