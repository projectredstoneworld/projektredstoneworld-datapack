...
execute at @s unless score @s rcrailpay matches 1.. if score @s rcorpsec matches 1 run tellraw @s {"text":"Automatically signing you up for RCorp Rail to allow access to trains. Applying 25% discount for level 1 RCorp status, now costs 1.5 emeralds per in game month. Cancel at Tower 3.","color":"green"}
execute at @s unless score @s rcrailpay matches 1.. if score @s rcorpsec matches 2 run tellraw @s {"text":"Automatically signing you up for RCorp Rail to allow access to trains. Applying 50% discount for level 2 RCorp status, now costs 1 emerald per in game month. Cancel at Tower 3.","color":"green"}
