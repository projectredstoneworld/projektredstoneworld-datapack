...
execute in overworld as @e[type=minecart,tag=rcraildrive,x=0,tag=rcrailaged,tag=!rcrailghost] at @s if score @s rcrailtimerdiff matches 600.. run function projektredstoneworld:rcrailtransit/killrcrailcar
...
execute in overworld as @e[type=minecart,tag=rcraildrive,x=0,tag=!rcrailaged,tag=!rcrailghost] at @s if score @s rcrailtimerdiff matches 1200.. run function projektredstoneworld:rcrailtransit/killrcrailcar
...
#execute if score #rcrailghostpodtime info matches 3600.. unless score #rcrailghostpodnum info matches 5.. run function projektredstoneworld:rcrailtransit/ghostpodspawn
