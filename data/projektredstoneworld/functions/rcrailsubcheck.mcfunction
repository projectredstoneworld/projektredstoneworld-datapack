...
execute if score @s rcrailpay matches 2 run scoreboard players operation @s rcraildebt *= 150 CONSTANTS
execute if score @s rcrailpay matches 3 run scoreboard players operation @s rcraildebt *= 100 CONSTANTS
