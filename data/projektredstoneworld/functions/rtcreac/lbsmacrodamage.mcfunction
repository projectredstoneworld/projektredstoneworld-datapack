...
execute as @a[distance=..56] run damage @s 0.000000000000000000000000000000000000000000001 mob_attack by @e[type=vindicator,name="their own incompetence",limit=1,x=82,y=-55,z=600,dx=4,dy=4,dz=4]
