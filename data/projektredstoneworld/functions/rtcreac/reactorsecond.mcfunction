...
execute if score #rtcreactorstability info matches 100 if score #rtcreactorai info matches -1 run function projektredstoneworld:rtcreac/aievil
...
execute if score #rtcreactorai info matches 1 if score #rtcreactorstability info matches 100 if score #rtcreactorcoretemp info matches 141.. if score #rtcreactorturbinerush info matches 1 run function projektredstoneworld:rtcreac/ai
...
scoreboard players operation #rtcreactorauxwattageabs info = #rtcreactorauxwattage info
...
execute if score #rtcreactorspewtime info matches 1.. if score #rtcreactorspewmode info matches 1 as @a[distance=..620] at @s run playsound entity.elder_guardian.curse master @s ~ ~ ~ 1 0 1
...
execute positioned 186.5 -56.0 606.5 store result entity @e[type=marker,tag=skibidirizzlerenjoythisplaceholder,distance=..1,limit=1] data.far float 0.19 run scoreboard players get #rtcreactorintermediate info
execute positioned 186.5 -56.0 606.5 store result entity @e[type=marker,tag=skibidirizzlerenjoythisplaceholder,distance=..1,limit=1] data.near float 0.31 run scoreboard players get #rtcreactorintermediate info
