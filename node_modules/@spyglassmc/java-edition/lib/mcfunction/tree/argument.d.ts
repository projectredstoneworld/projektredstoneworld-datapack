...
export interface NbtParserProperties extends Record<string, unknown> {
     ...
     */
    dispatcher: 'minecraft:block' | 'minecraft:entity' | 'minecraft:storage' | 'minecraft:macro_function';
    /**
